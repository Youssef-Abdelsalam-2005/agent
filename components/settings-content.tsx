      ...
      <div className="space-y-8">
        ...
        >
          <div className="space-y-4">
            <div>
              ...
              <CustomInput placeholder="Your name" defaultValue="John Doe" className="h-10 px-0" />
            </div>
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-2">Email</label>
              <CustomInput placeholder="your@email.com" defaultValue="john@example.com" className="h-10 px-0" />
            </div>
            <Button className="bg-orange-500 text-black hover:bg-orange-400">Save Changes</Button>
          </div>
        </SettingsSection>
        ...
        >
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select value={model} onValueChange={setModel}>
                ...
                <SelectContent className="bg-zinc-900 border-white/10">
                  ...
                  {provider === "xai" && <SelectItem value="grok-3">Grok 3</SelectItem>}
                  {provider === "groq" && (
                    <>
            ...
            <div>
              ...
              <CustomInput placeholder="0.7" defaultValue="0.7" className="h-10 px-0" />
            </div>
            <div>
              <label className="block text-sm font-medium text-zinc-300 mb-2">Max Tokens</label>
              <CustomInput placeholder="2048" defaultValue="2048" className="h-10 px-0" />
            </div>
          </div>
        </SettingsSection>
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="text-zinc-100 font-medium">Push Notifications</h4>
                <p className="text-sm text-zinc-400">Receive notifications about uploads and processing</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-zinc-400">Get weekly summaries of your activity</p>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-zinc-400">Encrypt all uploaded files and conversations</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-zinc-400">Help improve the product with usage analytics</p>
              </div>
              <Switch defaultChecked={true} />
            </div>
  ...
  return (
    <div className="bg-black/20 backdrop-blur rounded-2xl p-6">
      <div className="flex items-start gap-4 mb-6">
        <div className="rounded-lg bg-orange-500/20 p-2 text-orange-400">{icon}</div>
        <div>
